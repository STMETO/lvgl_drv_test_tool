...
static void my_btn_up_event_cb(lv_event_t * e)
{
	...
	if(code_e == LV_EVENT_CLICKED)
	{
		...
		{
			sprintf(file_name, "/home/pictures/%03d.jpg", ++file_name_num_id);
			...
			file_umg_cnt++;
			sprintf(file_name, "S:/home/pictures/%03d.jpg", file_name_num_id);
			lv_label_set_text_fmt(Label_name, "#519ABA 当前查看的文件:/home/pictures/%03d.jpg#", file_name_num_id);
...
{ 
	...
	// lv_label_set_text(Label_name, "#519ABA 当前查看的文件:/home/pictures/001.jpg#");
	lv_obj_align_to(Label_name, Frame_obj, LV_ALIGN_TOP_LEFT, -100, -50);

	char file_name[50];
	file_name_num_max = list_files("/home/pictures/");
